...
public class ItemProp : MonoBehaviour {
    ...
    public void Set(int id,int amount,Sprite image,int state)
    {
    ...
    public void OnItemPressed()
    {
        ...
        {
            transform.parent.GetComponent<InvetoryController>().OnItemPressed(_ID);
        ...
        {
            transform.parent.GetComponent<ShopItem>().OnItemPressed(_ID);
        }
        else if (_state == 3)//equipment
        {
            transform.parent.GetComponent<ShowEquipItem>().OnItemPressed(_ID);
        ...
        else if (_state == 4)//forge
        {
            ...
            transform.parent.GetComponent<ForgeSystem>().SetIndex(_ID);
